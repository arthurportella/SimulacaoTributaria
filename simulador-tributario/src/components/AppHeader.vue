...
// Computa o nome para exibição (Prioriza o Nome, senão usa o começo do e-mail)
...
// Computa as iniciais (Ex: Arthur Portella -> AP)
...
.user-profile-badge:hover {
    ...
    border-color: var(--cor-primaria-leve);
}
...
@media (max-width: 600px) {
    ...
    .user-details { display: none; } /* Esconde o nome em celulares, deixa só o avatar */
